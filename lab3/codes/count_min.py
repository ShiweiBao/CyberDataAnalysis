...
# -*- coding: utf-8 -*-
"""
Created on Tue Jun 27 20:42:18 2017
...
class CountMinSketch(object):
    ...
    def __len__(self):
        ...
        """
        return self.n
# w is value space, d is number of hash function
# w columns,d rows, in the count matrix
# save space, limited w causes collision, we choose the minimum collision one as our estimation
#however, collision still causes over-estimation.   
sketch = CountMinSketch(10000, 5)  # table size=10000, hash functions=5
lines=open('src_ip.txt').read().splitlines()
for line in lines:
    sketch.add(line)
print sketch['115.177.11.215']
print sketch['115.176.182.196']
print sketch['192.3.106.42']
print sketch['191.96.249.189']
print sketch['104.192.0.20']
print sketch['198.204.234.26']
print sketch['198.204.234.27']
print sketch[' 198.204.234.28 ']
print sketch['185.93.185.10']
print sketch['198.204.234.30']
print '----------------------------------------'

sketch = CountMinSketch(100000, 5)  # table size=100000, hash functions=5
lines=open('src_ip.txt').read().splitlines()
for line in lines:
    sketch.add(line)
print sketch['115.177.11.215']
...
sketch = CountMinSketch(100000, 3)  # table size=100000, hash functions=5
lines=open('src_ip.txt').read().splitlines()
for line in lines:
    sketch.add(line)
print sketch['115.177.11.215']
